...
class QueryResponse(BaseModel):
    ...
    service_latencies: dict | None = Field(
...
class ClarificationResponse(BaseModel):
    ...
    selected_option: str | None = Field(None, description="Selected clarification option")
    revised_query: str | None = Field(None, description="Revised query")
